...
import com.dzzchao.learncustomview.BuildConfig;
import com.dzzchao.learncustomview.utils.DensityUtil;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if(BuildConfig.DEBUG) {
                    //真实坐标
                    Timber.d("getRawX: %s", ev.getRawX());
                    Timber.d("getRawY: %s", ev.getRawY());
                }
                // 释放动画
                ...
                if (!mConsumeMoveEvent) {
                    // 处理事件冲突 - 如果x轴距离大于y轴的距离，就不让父view拦截事件
